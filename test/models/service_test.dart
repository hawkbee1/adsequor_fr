...
void main() {
  group('Service Model', () {
    ...
    test('adsequorServices list contains all expected services', () {
      ...
      expect(adsequorServices.length, equals(2));

      // Test specific services
      expect(adsequorServices[0].id, equals('flutter_dev'));
      expect(adsequorServices[1].id, equals('it_consulting'));

      // Test service titles
      expect(adsequorServices[0].title, equals('Flutter Development'));
      expect(adsequorServices[1].title, equals('IT Consulting'));

      // Test image URLs
      expect(adsequorServices[0].imageUrl, equals('assets/flutter_dev.png'));
      expect(adsequorServices[1].imageUrl, equals('assets/consulting.png'));
